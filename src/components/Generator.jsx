...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={"generate your workout"} title={['It\'s', 'Boost', 'o\'clock']}>
            {/* first section */}
            ...
            {/* second section */}
            <Header index={'02'} title={'Select your target'} description={"Pick the muscles you would like to exercise"} />
                    ...
                    <div className='flex flex-col px-3 pb-3'>
                        {(poison === 'individual' ? WORKOUTS[poison] : Object.keys(WORKOUTS[poison])).map((muscleGroup, muscleGroupIndex) => {
                            return (
                                ...
                                }} key={muscleGroupIndex} className={'hover:text-blue-400 duration-200 px-4' + (muscles.includes(muscleGroup) ? ' text-blue-400' : ' ')}>
            ...
            {/* third section */}
            <Header index={'03'} title={'Pick your Boost'} description={"Select your objective."} />
